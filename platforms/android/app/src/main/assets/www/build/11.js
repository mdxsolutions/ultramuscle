...
var PlansPageModule = /** @class */ (function () {
    ...
    PlansPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__plans__["a" /* PlansPage */]),
...
var PlansPage = /** @class */ (function () {
    function PlansPage(_workoutService, loadingCtrl) {
    ...
    PlansPage.prototype.ionViewDidLoad = function () {
        ...
        loader.present().then(function () {
            _this.reloadPlans().then(function () {
                loader.dismiss();
            });
        });
    };
    PlansPage.prototype.reloadPlans = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this._workoutService.loadAllPlans()];
                    case 1:
                        _a.plans$ = _b.sent();
                        return [2 /*return*/];
                }
    ...
    PlansPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "page-plans",template:/*ion-inline-start:"C:\Users\ctorr\Documents\projects\ionic\ultramuscle-app\src\pages\plans\plans.html"*/'<ion-header>\n\n  <app-header title="Workouts"></app-header>\n\n</ion-header>\n\n\n\n\n\n<ion-content class="workout-bg">\n\n   <!-- Title Categories -->\n\n   <title-component title="Workout Plans"></title-component>\n\n\n\n   <!-- Card Categories -->\n\n   <category-card [items]="plans$ | async" goTo="WorkoutsPage"></category-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ctorr\Documents\projects\ionic\ultramuscle-app\src\pages\plans\plans.html"*/
        }),
