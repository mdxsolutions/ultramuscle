...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipes__ = __webpack_require__(559);
...
var RecipesPageModule = /** @class */ (function () {
    ...
    RecipesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__recipes__["a" /* RecipesPage */]),
...
var RecipesPage = /** @class */ (function () {
    function RecipesPage(navCtrl, navParams, _nutritionsService, loadingCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this._nutritionsService = _nutritionsService;
    ...
    RecipesPage.prototype.ionViewDidLoad = function () {
        ...
        loader.present().then(function () {
            _this.loadAllRecipes().then(function () {
                loader.dismiss();
            });
        });
    };
    RecipesPage.prototype.loadAllRecipes = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._nutritionsService.findRecipes(this.nutrition.id)
                                .subscribe(function (recipes) {
                                _this.recipes = recipes;
                                _this.title = _this.nutrition.name;
                            })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
    ...
    RecipesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-recipes',template:/*ion-inline-start:"C:\Users\ctorr\Documents\projects\ionic\ultramuscle-app\src\pages\recipes\recipes.html"*/'<ion-header>\n\n  <app-header [title]="pageTitle"></app-header>\n\n</ion-header>\n\n\n\n<ion-content class="nutrition-bg">\n\n  <title-component [title]="title"></title-component>\n\n  <recipe-card [item]="recipe" goTo="RecipeDetailPage" *ngFor="let recipe of recipes"></recipe-card>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\ctorr\Documents\projects\ionic\ultramuscle-app\src\pages\recipes\recipes.html"*/,
        }),
